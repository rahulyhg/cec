                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select
                                ...
                                <option
                                    value="{{ language.code }}"
                                    {% if formData['lcode'] is defined and formData['lcode'] == language.code %}
                                    selected="selected"
                                    {% endif %}>
                                    {{ language.name }}
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea
                                class="form-control"
                                placeholder=""
                                name="description">{% if formData['description'] is defined %}{{ formData['description'] }}{% endif %}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            ...
                            <select
                                ...
                                {% for n, cat in categories %}
                                    <option
                                        ...
                                        selected="selected"
                                        {% endif %}>
                                        {{ str_repeat('-', cat.level) }} {{ cat.getOneLangBySession().name }}
                                    </option>
                                {% endfor %}
                            </select>
                        </div>
