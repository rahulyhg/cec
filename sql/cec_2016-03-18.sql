...
# Database: cec
# Generation Time: 2016-03-18 14:35:16 +0000
# ************************************************************
...
CREATE TABLE `cec_article` (
  ...
  `a_status` tinyint(2) DEFAULT NULL,
  `a_display_order` int(11) DEFAULT NULL,
  `a_display_to_home` tinyint(2) DEFAULT NULL COMMENT 'co hien thi ngoai trang home hay ko',
  `a_type` tinyint(2) DEFAULT NULL COMMENT 'Hoat Dong / Normal / Page',
  `a_seo_description` text,
  `a_seo_keyword` text,
  `a_datecreated` int(10) DEFAULT NULL,
  `a_datemodified` int(10) DEFAULT NULL,
  PRIMARY KEY (`a_id`),
  KEY `c_id` (`c_id`),
...
CREATE TABLE `cec_category` (
  ...
  `c_lft` int(11) DEFAULT NULL,
  `c_rgt` int(11) DEFAULT NULL,
  `c_level` int(11) DEFAULT NULL,
  `c_status` int(11) DEFAULT NULL,
  `c_count` int(11) DEFAULT '0',
  `c_seo_description` text,
  `c_seo_keyword` text,
  `c_datecreated` int(11) DEFAULT NULL,
  `c_datemodified` int(11) DEFAULT NULL,
  PRIMARY KEY (`c_id`),
...
CREATE TABLE `cec_contact` (
  ...
  `co_content` text,
  `co_datecreated` int(10) DEFAULT NULL,
  `co_datemodified` int(10) DEFAULT NULL,
  PRIMARY KEY (`co_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `cec_image` (
  ...
  `i_status` tinyint(2) DEFAULT NULL,
  `i_size` int(11) DEFAULT NULL,
  `i_datecreated` int(10) DEFAULT NULL,
  `i_datemodified` int(10) DEFAULT NULL,
  PRIMARY KEY (`i_id`),
  KEY `a_id` (`a_id`),
  KEY `p_id` (`p_id`),
...
CREATE TABLE `cec_product` (
  ...
  `p_seo_keyword` text,
  `p_datecreated` int(10) DEFAULT NULL,
  `p_datemodified` int(10) DEFAULT NULL,
  PRIMARY KEY (`p_id`),
  KEY `pc_id` (`pc_id`),
...
CREATE TABLE `cec_product_category` (
  ...
  `pc_root` int(11) DEFAULT NULL,
  `pc_lft` int(11) DEFAULT NULL,
  `pc_rgt` int(11) DEFAULT NULL,
  `pc_level` int(11) DEFAULT NULL,
  `pc_status` int(11) DEFAULT NULL,
  `pc_count` int(11) DEFAULT NULL,
  `pc_seo_description` text,
  `pc_seo_keyword` text,
  `pc_datecreated` int(11) DEFAULT NULL,
  `pc_datemodified` int(11) DEFAULT NULL,
  PRIMARY KEY (`pc_id`),
  KEY `pc_root` (`pc_root`),
  KEY `pc_lft` (`pc_lft`),
  KEY `pc_rgt` (`pc_rgt`),
...
CREATE TABLE `cec_slug` (
  ...
  `s_objectid` int(11) DEFAULT NULL,
  `s_model` varchar(255) NOT NULL DEFAULT '',
  `s_status` smallint(2) DEFAULT NULL,
  `s_datecreated` int(10) DEFAULT NULL,
  `s_datemodified` int(10) DEFAULT NULL,
  PRIMARY KEY (`s_id`),
  KEY `u_id` (`u_id`),
  KEY `s_slug` (`s_slug`),
  KEY `s_hash` (`s_hash`),
...
VALUES
	(1,'Administrator','admin@fly.com','$2a$10$bHgIzgr2jQLmlDEJg3JRvOdy82Tcdf8P8HmoJrIJliR7M3fOBXApi',5,'/uploads/avatar/2016/03/12745522-1168033236555228-5650083758396135947-n-1457686175.jpg',1,0,1457686177);
